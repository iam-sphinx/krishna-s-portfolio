  ...
  return (
    <div className="min-h-screen bg-[#00030a] relative">
      ...
      <div className="absolute sm:w-[74.5rem] w-[22.6875rem] sm:top-[12.75rem] sm:right-[7.25rem] top-[11.5625rem] right-[1.6875rem] flex flex-wrap justify-end">
        <Link to="/home">
          <h1 className="font-PlayFair_Display font-bold sm:text-[8.07rem] sm:leading-[9.6837rem] text-[2.75rem] leading-[3.3rem] tracking-[0.125rem] text-right hover:text-white text-[#2D2D2D]">
            Home \
          </h1>
        </Link>
