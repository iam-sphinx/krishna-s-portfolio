        ...
        <div className="w-full h-full flex items-end ml-[6.438rem]">
          <div>
            <p className="font-GT_America_Trial text-[1.214rem] leading-[1.456rem] text-justify text-[#86939F] font-normal mb-5">
              ...
              the food there, yeah not for me. Hey, I’m all about trying out new
              things but not when it comes to food- I stick to McD whenever and
              wherever needed.
            </p>
            ...
            <p className="font-GT_America_Trial text-[1.214rem] leading-[1.456rem] text-justify text-[#86939F] font-normal">
              ...
              harder and be better. So if you’re ever not feeling up to it, just
              think about what the real me told you to do- take care of the
              small things and the more significant things shall fall into
              place. just stop yourself, clear your head, and breathe. One day,
              you’ll be sitting on the bed with your legs crisscrossed pondering
              how to introduce yourself and document all your achievements and
              the crazy highlights of your life just like I am right now.
            </p>
          </div>
        </div>
      </div>
