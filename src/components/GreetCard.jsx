      ...
      <div className="flex flex-col gap-[0.875rem] sm:mb-[3.5rem] mb-[1.375rem]">
        <Slide cascade damping={1} triggerOnce>
          ...
          <p className="font-Eskell_Display font-light text-white sm:text-5xl text-2xl  sm:w-[56.25rem] w-auto">
            Greetings, I'm Krishna, and I specialise in creating diverse
            creations tailored for the digital landscape.
          </p>
        </Slide>
      </div>
        ...
        <div className="font-GT_America_Trial font-normal sm:text-2xl text-base leading-[1.2rem] text-justify text-[#86939F]">
          <Fade direction="right" cascade damping={1} triggerOnce>
            <p className="mb-5">
              ...
              spending time contemplating, writing, and discussing their impacts
              on organisations, teams, and end-users.{" "}
            </p>
            <p>
              ...
              simply invite me for a coffee, virtually or in person. Let's
