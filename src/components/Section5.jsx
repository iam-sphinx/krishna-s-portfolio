...
const Section5 = () => {
  ...
  return (
    <div className="w-full sm:h-[80.5rem] h-[47.9375rem]  overflow-hidden relative ">
      ...
      ></div>
      <div className="absolute sm:top-[25.55rem] top-[17.375rem] left-[50%] translate-x-[-50%] z-20">
        <CustomAnimation>
          <div
      ...
      <div className="absolute sm:top-[20.5rem] top-[11.25rem] left-[50%] translate-x-[-50%]">
        <CustomAnimation>
          <p className="text-center font-GT_America_Trial font-normal sm:text-[1.25rem] sm:leading-[1.75rem] text-[1rem] leading-[1.2rem] sm:tracking-[1%] text-[#86939F] sm:mt-[1.875rem] sm:w-[45.875rem] w-[19.625rem]">
            i like to keep note of whatever is going on in my life. They’re
            things that define me as a person so go ahead, give it a read!
          </p>
        </CustomAnimation>
      </div>
      {/* files cards */}
